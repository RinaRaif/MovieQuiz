...
//  MovieQuizTests
//
//  Created by Рина Райф on 17.04.2024.
//

import XCTest // импортируем фреймворк для тестирования

@testable import MovieQuiz // импортирую приложение для тестирования
...
class MoviesLoaderTests: XCTestCase {
    ...
    func testFailureLoading() throws { // проверка ошибки загрузки данных
        // Given
